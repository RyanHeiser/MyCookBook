...
{
    public class MoveCommand<TChild, TParent> : AsyncCommandBase where TChild : ChildDomainObject where TParent : DomainObject
    {
        ...
        public MoveCommand(MoveStore moveStore, NavigationStore navigationStore, ChildRecipeStoreBase<TChild, TParent> childStore, RecipeStoreBase<TParent> parentStore, TChild itemToMove)
        {
        ...
        /// <summary>
        /// Moves a Recipe of RecipeCategory to the current parent.
        /// </summary>
        /// <param name="parameter"></param>
        /// <returns></returns>
        public override async Task ExecuteAsync(object? parameter)
        {
            ...
            {
                await _childStore.Move(_itemToMove, _parentStore.Current.Id);
